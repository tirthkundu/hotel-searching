...
const getPropertyBookings = async function (params) {
    try {
        parametersValidator(getPropertiesValidator.propertyBookingsValidator, params)
        let propertyBookingList = await propertiesModel.getPropertyBookingDetails(params)
